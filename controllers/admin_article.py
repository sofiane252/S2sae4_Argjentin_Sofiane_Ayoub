...
def show_article():
    ...
    # print(articles)
    return render_template('admin/article/show_article.html', voitures=voitures)
...
def add_article():
    ...
    sql = "SELECT * FROM voiture"
    mycursor.execute(sql)
    voiture = mycursor.fetchall()
    return render_template('admin/article/add_article.html', type_voiture=type_voiture, voiture=voiture) #types_articles=types_articles)
